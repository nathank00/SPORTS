# ---------------------------------------------- CREATE "unsorted" Master Data set -------------------------------------------------
...
print(f"Master dataset saved to {output_path} - SUCCESS")


# ----------------------------------------------------------------------- SORTING Data set + FILTERING out irrelevant dates ---------------------------------------------------------------------
...
# ------------------------------------------------------------ GENERATE Bullpen Average stats + removing Bullpen Individual stats ---------------------------------------------------


# Load the dataset
file_path = 'model/masterdata.csv'
df = pd.read_csv(file_path)
...
def calculate_bullpen_averages(team_prefix):
    for stat in pitcher_columns:
        stat_columns = [f"{team_prefix}_bullpen_{i}_{stat}" for i in range(1, 15)]
...
print("Generated bullpen avg stats - SUCCESS.")
...
print(f"DATASET COMPLETE - located at {file_path}")