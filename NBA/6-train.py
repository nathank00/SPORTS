...
xgb_selected.save_model('model/xgboost_nba_winner_model.json')
logging.info("Saved model to model/xgboost_nba_winner_model.json")
joblib.dump(scaler, 'model/scaler.pkl')
logging.info("Saved scaler to model/scaler.pkl")
joblib.dump(selector, 'model/feature_selector.pkl')
logging.info("Saved feature selector to model/feature_selector.pkl")
